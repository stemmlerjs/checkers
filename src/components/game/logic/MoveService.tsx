...
export class MoveService {
  ...
  private computeDirectionality (start: Position, target: Position): Directionality {
  ...
  private isDirectionalityValid (piece: Piece, directionality: Directionality): boolean {
  ...
  public canMovePiece (board: Board, piece: Piece, targetPosition: Position): boolean {
    const directionality = this.computeDirectionality(piece.getPosition(), targetPosition);
    const isDirectionalityValid = this.isDirectionalityValid(piece, directionality);
